...
namespace DMotMTests.ChazzPrinceton
{
    ...
    public class ArmedDragonLv5CardControllerTests : BaseTest
    {
        ...
        [Test]
        public void Play_DuringYourStartOfTurn_DoesNotDestroy()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void Play_DuringYourPlayPhaseWithNoOtherTargets_DestroysSelf()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void Play_DuringYourPlayPhaseWithOtherTargets_DestroysATarget()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void Play_DuringYourPowerPhaseWithNoOtherTargets_DestroysSelf()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void Play_DuringYourPowerPhaseWithOtherTargets_DestroysATarget()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void Play_DuringYourEndOfTurn_DoesNotDestroy()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void Play_DuringOtherStartOfTurn_DoesNotDestroy()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void Play_DuringOtherPlayPhase_DoesNotDestroy()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void Play_DuringOtherPowerPhase_DoesNotDestroy()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void Play_DuringOtherEndOfTurn_DoesNotDestroy()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void AtStartOfYourSameTurn_WithLv7InHand_DoesNothing()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void AtStartOfOtherTurn_WithLv7InHand_DoesNothing()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void AtStartOfYourNextTurn_WithNoLv7InHand_DoesNothing()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void AtStartOfYourNextTurn_WithLv7InHandButChooseNotToPlay_DoesNothing()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void AtStartOfYourNextTurn_WithLv7InHandAndChooseToPlay_PlaysLv7AndDestroysSelf()
        {
            // Setup a sample game with Chazz Princeton, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Legacy", "Megalopolis");
            StartGame();
        ...
        [Test]
        public void AtEndOfYourTurn_WithMultipleTargetsInPlay_DealsDamageWithDecision()
        {
            ...
            // We will deal damage to teh villain
            AssertNextDecisionChoices(includedCards, notIncludedCards);
            ...
            Assert.That(baron.CharacterCard.HitPoints, Is.EqualTo(villainHP - 2));
        }

        [Test]
        public void AtEndOfOtherTurn_DealsNoDamage()
        {
            // Setup a sample game with Chazz Princeton and Luminary, the villain and environment don't matter
            SetupGameController("BaronBlade", ChazzPrincetonConstants.Deck, "Luminary", "Megalopolis");
            StartGame();
